...
public interface QueryUpdateEmitterService {
    ...
    /**
     * Informs the subscribed query that there is an update for the query result, as far as the parameters
     * of the query match the given predicate for the updates.
     *
