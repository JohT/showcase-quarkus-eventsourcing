...
public class NicknameRepository {
    ...
    /**
     * Updates the nicknames and returns {@code true} if it was newly created,
     * or {@code false} if it was already in use.
     *
     * @param details {@link NicknameDetails}
     * @return {@code true} if the nickname is distinct (first occurrence)
     */
    ...
    /**
     * Reads all nicknames that are like the given part, created after the given instant.
     *
     * @param partOfNickname {@link String}
     * @param createdAfter   {@link Instant}
