...
/**
 * Deals with query results wrapped inside {@link CompletableFuture}s that need to be provided synchronously.
 *
...
class SynchonousQueryResult<T> {
    ...
    /**
     * Waits for the result until the timeout for queries is reached or another exception occurred.
     *
