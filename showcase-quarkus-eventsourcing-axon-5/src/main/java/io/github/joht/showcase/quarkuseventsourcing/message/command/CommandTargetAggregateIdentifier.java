 ...
 * <p>
 * This is a pure boundary annotation with no framework dependency.
 * Routing to the correct entity is configured via
 * {@code CommandTargetAnnotationEntityIdResolverDefinition}.
 */
@Documented
