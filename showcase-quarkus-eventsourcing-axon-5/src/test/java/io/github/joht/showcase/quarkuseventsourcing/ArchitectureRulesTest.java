...
public class ArchitectureRulesTest {
    ...
    void boundaryShouldNotUseAxonDirectly() {
        classes().that().resideInAPackage("..boundary..")
                .and().areNotAnnotatedWith(Retention.class)
    ...
    void commandModelShouldNotUseAxonDirectly() {
        classes().that().resideInAnyPackage("..domain..")
                .should().onlyDependOnClassesThat().resideOutsideOfPackages("..axon..", "..axonframework..")
                .orShould().dependOnClassesThat().belongToAnyOf(EntityCreator.class, InjectEntityId.class)
                .check(classes);
    }
    ...
    void testEqualsAndHashcodeMethodsFulfillTheContract() {
        codeUnits().that()
                ...
                .and().areDeclaredInClassesThat().areNotMetaAnnotatedWith(EventSourcedEntity.class)
    ...
    private static class FulfillEqualsHashcodeContract extends ArchCondition<JavaCodeUnit> {
        ...
        public static ArchCondition<JavaCodeUnit> suppress(Warning... warnings) {
        ...
        public static ArchCondition<JavaCodeUnit> using(ConfiguredEqualsVerifier verifier) {
